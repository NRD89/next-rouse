      ...
      <div className="w-full mt-10">
        <div className="mx-auto max-w-prose">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            unless otherwise noted, all references to Rouse Yoga include
            https://rouse.yoga. The Rouse Yoga website is a subscription site.
            By using the Rouse Yoga website, you consent to the data practices
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            provide these services to Rouse Yoga, and they are required to
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            comply with legal process served on Rouse Yoga or the site; (b)
            protect and defend the rights or property of Rouse Yoga; and/or (c)
            act under exigent circumstances to protect the personal safety of
            users of Rouse Yoga, or the public.{" "}
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            content and advertising within Rouse Yoga to customers whose
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            provide general statistics regarding use of the Rouse Yoga website.{" "}
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            you personalize Rouse Yoga pages, or register with Rouse Yoga site
            or services, a cookie helps Rouse Yoga to recall your specific
            ...
            shipping addresses, and so on. When you return to the same Rouse
            Yoga website, the information you previously provided can be
            retrieved, so you can easily use the Rouse Yoga features that you
            customized.{" "}
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            interactive features of the Rouse Yoga services or websites you
            visit.{" "}
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            or guardian to use this website.{" "}
          </p>
