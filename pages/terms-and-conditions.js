      ...
      <div className="w-full mt-10">
        <div className="mx-auto max-w-prose">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            herein (the "Terms"). Your use of https://rouse.yoga constitutes
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            entity. You acknowledge that Rouse Yoga is not responsible for third
            party access to your account that results from theft or
            misappropriation of your account. Rouse Yoga and its associates
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            Site, or any changes or updates to a Linked Site. Rouse Yoga is
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            domain, you hereby acknowledge and consent that Rouse Yoga may share
            such information and data with any third party with whom Rouse Yoga
            has a contractual relationship to provide the requested product,
            service or functionality on behalf of https://rouse.yoga users and
            customers.
          </p>
          <h2 className="h4 font-red-hat-display mb-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            warrant to Rouse Yoga that you will not use the Site for any purpose
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            the Site. Rouse Yoga content is not for resale. Your use of the Site
            ...
            Rouse Yoga and the copyright owner. You agree that you do not
            ...
            property of Rouse Yoga or our licensors except as expressly
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            discretion. Rouse Yoga reserves the right to terminate your access
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            Rouse Yoga's sole discretion. Always use caution when giving out any
            personally identifying information about yourself or your children
            in any Communication Service. Rouse Yoga does not control or endorse
            the content, messages or information found in any Communication
            Service and, therefore, Rouse Yoga specifically disclaims any
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            are granting Rouse Yoga, our affiliated companies and necessary
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            all local laws. You agree that you will not use the Rouse Yoga
            Content accessed through https://rouse.yoga in any country or in any
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            (including reasonable attorney's fees) relating to or arising out of
            ...
            of any applicable laws, rules or regulations. Rouse Yoga reserves
            ...
            in which event you will fully cooperate with Rouse Yoga in asserting
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            first be mediated by a mutually agreed upon mediator through the
            Alternative Dispute Resolution Center in Los Angeles, and if not
            resolved via mediation, then by final and binding arbitration
            pursuant to the Federal Arbitration Act, conducted by a mutually
            agreed upon single neutral arbitrator at Alternative Dispute
            Resolution in Los Angeles. the American Arbitration Association, or
            a similar arbitration service selected by the parties, in a location
            ...
            costs and reasonable attorney's fees. The parties agree to mediate
            and/or arbitrate all disputes and claims in regards to these Terms
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            PARTIES AGREE THAT A PARTY MAY br/ING CLAIMS AGAINST THE OTHER ONLY
            IN EACH'S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS
            MEMBER IN ANY This is a RocketLawyer.com document. PUTATIVE CLASS,
            COLLECTIVE AND/ OR REPRESENTATIVE PROCEEDING, SUCH AS IN THE FORM OF
            A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless
            both you and Rouse Yoga agree otherwise, the arbitrator may not
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            WARRANTY OR CONDITION OF ANY KIND. ROUSE YOGA AND/OR ITS SUPPLIERS
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            STRICT LIABILITY OR OTHERWISE, EVEN IF ROUSE YOGA OR ANY OF ITS
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            contained in this agreement is in derogation of Rouse Yoga's right
            ...
            provided to or gathered by Rouse Yoga with respect to such use. If
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            and Rouse Yoga with respect to the Site. A printed version of this
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            Yoga encourages you to periodically review the Terms to stay
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <br /> Effective as of November 11, 2020
          </p>
        </div>
      </div>
    </Layout>
