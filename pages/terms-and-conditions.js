  ...
  return (
    <Layout>
      <div className="w-full text-center">
        <h1 className="h1 text-indigo-500 capitalize">Terms And Conditions</h1>
      </div>
      <div className="w-full mt-10">
        <div
          ...
          style={{ maxWidth: `75ch` }}
        >
          <p className="p1">ROUSE YOGA TERMS AND CONDITIONS</p>
          <p className="p2">Last updated [December, 2020]</p>
          <p className="p3">
            <br />
          </p>
          <p className="p3">
          ...
          <p className="p4">AGREEMENT TO TERMS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
            ...
            Rpuse Yoga(&ldquo;we,&rdquo; &ldquo;us&rdquo; or &ldquo;our&rdquo;),
            concerning your access to and use of the rouse.yoga website as well
          ...
          <p className="p1">
            ...
            updated&rdquo; date of these Terms and Conditions, and you waive any
          ...
          <p className="p1">
            ...
            posted.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            <span className="s1">created using Termly.</span>
          </p>
          <p className="p6">
            <br />
          </p>
          <p className="p1">
            ...
            the Site.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p4">INTELLECTUAL PROPERTY RIGHTS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p4">USER REPRESENTATIONS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            current, and complete;<strong>&nbsp;</strong>(2) you will maintain
          ...
          <p className="p4">USER REGISTRATION</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">&nbsp;</p>
          <p className="p4">PROHIBITED ACTIVITIES</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">As a user of the Site, you agree not to:</p>
          <p className="p3">
            <br />
          </p>
          <ul className="ul1">
            ...
            <li className="li1">sell or otherwise transfer your profile.</li>
            <li className="li1">
          ...
          <p className="p4">CONTRIBUTION LICENSE</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            Contributions. <span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p4">GUIDELINES FOR REVIEWS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            being reviewed;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            conduct;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            partners.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p4">MOBILE APPLICATION LICENSE</p>
          <p className="p5">
            <br />
          </p>
          <p className="p10">Use License</p>
          <p className="p1">
            ...
            of this mobile application license contained in these Terms and
          ...
          <p className="p1">
            You shall not:<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            or intended;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          <p className="p1">
            ...
            the same time;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p10">Apple and Android Devices</p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            Account (the &ldquo;Social Network Content&rdquo;) so that it is
          ...
          <p className="p1">
            ...
            Submissions.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p4">THIRD-PARTY WEBSITES AND CONTENT</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            party.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          <p className="p1">
            ...
            Websites.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          <p className="p4">ADVERTISERS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            our Digital Millennium Copyright Act (&ldquo;DMCA&rdquo;) Notice and
          ...
          <p className="p4">SITE MANAGEMENT</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            authorities;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          <p className="p1">
            ...
            thereof;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          <p className="p1">
            ...
            to our systems;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            <span className="s2">[</span>Further, we do not knowingly accept,
            request, or solicit information from children or knowingly market to
            children. Therefore, in accordance with the U.S. Children&rsquo;s
          ...
          <p className="p10">Notifications</p>
          <p className="p12">
            <br />
          </p>
          <p className="p1">
            ...
            below (a &ldquo;Notification&rdquo;).
            <span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          ...
          <p className="p1">
            ...
            &sect; 512(c)(3) and include the following information:
            <span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          ...
          <p className="p1">
            ...
            infringed;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            contacted;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            are located;<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">(6) your physical or electronic signature.</p>
          <p className="p3">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">Designated Copyright Agent</p>
          <p className="p1">[Name]</p>
          <p className="p1">Attn: Copyright Agent</p>
          <p className="p1">[Address]</p>
          <p className="p1">[City, State Zip]</p>
          <p className="p1">[email]</p>
          <p className="p3">
            <br />
          </p>
          <p className="p4">COPYRIGHT INFRINGEMENTS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p4">TERM AND TERMINATION</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            or errors.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            state]<strong>&nbsp;</strong>applicable to agreements made and to be
            entirely performed within the State/Commonwealth of [name of state],
          ...
          <p className="p13">DISPUTE RESOLUTION</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            Transaction Act (UCITA) are excluded from these Terms and
            Conditions. In no event shall any claim, action, or proceeding
          ...
          <p className="p14">Option 2: Informal Negotiations</p>
          <p className="p1">
            ...
            provided below) informally for at least <strong>______</strong> days
          ...
          <p className="p14">Binding Arbitration</p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            and expenses.]<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            way to the Site be commenced more than _____ years after the cause
          ...
          <p className="p14">Option 3: Binding Arbitration</p>
          <p className="p1">
            To expedite resolution and control the cost of any dispute,
            controversy or claim related to these Terms and Conditions (each a
            &quot;Dispute&quot; and collectively, &ldquo;Disputes&rdquo;), any
            Dispute brought by either you or us (individually, a
            &ldquo;Party&rdquo; and collectively, the &ldquo;Parties&rdquo;)
          ...
          <p className="p1">
            ...
            fails to do so.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">
            ...
            related in any way to the Site or Services be commenced more than
          ...
          <p className="p14">Option 2/Option 3: Restrictions</p>
          <p className="p1">
          ...
          <p className="p1">&nbsp;</p>
          <p className="p4">LIMITATIONS OF LIABILITY</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p4">INDEMNIFICATION</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p4">CALIFORNIA USERS AND RESIDENTS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p4">MISCELLANEOUS</p>
          <p className="p5">
            <br />
          </p>
          <p className="p1">
          ...
          <p className="p1">
            ...
            drafted them.<span className="Apple-converted-space">&nbsp;</span>
          </p>
          <p className="p3">
            <br />
          </p>
          ...
          <p className="p1">[Rouse Yoga</p>
          <p className="p1">[1051 E Alessandro Blvd</p>
          <p className="p1">Riverside, CA92509]</p>
          <p className="p1">951-334-6704</p>
          <p className="p1">
            [rouseyogastudio@gmail.com]
            <span className="Apple-converted-space">&nbsp;</span>
          </p>
        </div>
      </div>
