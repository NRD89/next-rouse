        ...
        <div className="w-full mt-10">
          ...
          >
            ...
            <p className="mt-4">
              ...
              journey we develop this incredible ability to connect more deeply
              to the world around us. This is what led me to founding Rouse Yoga
              and what drives me to do what I do every day.
            </p>
            <p className="mt-4">
              ...
              fighter for the things that matter. And what matters to me is{" "}
              <span className="font-bold text-gray-50">YOU</span>.
            </p>
            <p className="mt-4">
              I want you to discover your power and connect to yourself deeply,
              so that you have no choice but to give yourself everything you
              want. And in that, I created Rouse Yoga, a platform of expression,
              community, love, power and self-discovery. We don’t just teach
              yoga, we help you find power, understanding and purpose in your
