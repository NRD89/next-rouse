    ...
    >
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          {/* Site navigation */}
          <nav className="flex">
            <ul className="lg:flex flex-grow justify-start flex-wrap items-center hidden text-sm">
              <li>
                <Link href="/about">
            ...
            <ul className="flex items-center">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <li>
                    <div>
                      <Link href="/signup">
                        <a className="btn-sm font-medium text-gray-200 bg-tertiary hover:bg-tertiary-dark ml-3 px-5 py-3 rounded-md transition duration-150 ease-in-out text-xs md:text-sm">
                          <span>Sign Up</span>
                          <svg
                            className="w-3 h-3 fill-current text-gray-400 flex-shrink-0 ml-2 -mr-1 inline-block"
                            viewBox="0 0 12 12"
              ...
              <li>
                <div className="pl-4 w-10 h-10 rounded-full text-gray-100 lg:hidden flex justify-center items-center shadow-md">
                  <motion.div
                    initial={false}
                  ...
                  >
                    <button
                      onClick={togglePopUp}
                      className="bg-transparent pt-2 text-gray-100"
                      aria-label="Nav"
                      aria-haspopup="true"
                    >
