...
const BlogSingle = ({ data }) => {
  const renderers = {
    ...
    image: ({ alt, src }) => (
      <img alt={alt} src={src} style={{ margin: `0 auto` }} />
    ),
  };
  return (
            ...
            <article>
                  ...
                  >
                    <a href="#0">
                      <img
                        ...
                        src={`http://localhost:1337${data[0].instructor.avatar.formats.thumbnail.url}`}
                        width="32"
                        height="32"
                        alt="Author 04"
                      />
              ...
              >
                ...
                <figure className="mb-8">
                  <Image
                    className="w-full"
                    src="c_scale,f_auto,q_auto,w_768/v1615956857/news-02.jpg"
                    width="768"
                    height="432"
                    alt="News inner"
                  />
                ...
                {/* <figure className="mb-8 md:float-left md:max-w-sm md:mr-8 lg:max-w-none lg:-ml-32">
                  <img
                    className="mx-auto"
                    src={require("../images/news-inner-image-left.jpg")}
                    width="480"
                    height="300"
                    alt="News inner left"
                  />
                ...
                >
                  ...
                  <form>
                    <div className="relative flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-sm sm:px-4">
                      ...
                      />
                      <a
                        className="btn-sm text-white bg-teal-500 hover:bg-teal-400 flex-shrink-0"
                        href="#0"
                      >
                        Subscribe
                      </a>
